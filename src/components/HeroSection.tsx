  ...
  const scrollToDemo = () => {
   ...
   return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="max-w-[1160px] mx-auto px-6 md:px-8 relative z-10 py-24 md:py-32 lg:py-40">
        {/* Subtitle */}
        <p className="text-foreground/50 text-xs md:text-sm uppercase tracking-[0.2em] mb-16 md:mb-24 animate-fade-in font-medium">
          WhatsApp Outreach Infrastructure
        </p>

        {/* Headline — full width, LP style */}
        <h1 className="font-headline max-w-4xl mb-8 animate-fade-in" style={{ animationDelay: "0.1s", fontSize: "clamp(2.8rem, 6vw, 5rem)", fontWeight: 800, lineHeight: 1.05, letterSpacing: "-0.03em" }}>
        ...
        {/* Divider */}
        <div className="w-16 h-px bg-border mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }} />

        {/* Supporting paragraph */}
        <p className="text-lg md:text-xl lg:text-2xl text-foreground/50 max-w-2xl mb-12 leading-relaxed font-light animate-fade-in" style={{ animationDelay: "0.3s" }}>
        ...
        {/* Qualifier */}
        <p className="text-sm md:text-base text-foreground/30 max-w-lg leading-relaxed mb-12 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          Built for agencies, consultancies, and service businesses selling high-ticket offers via personal outreach.
        </p>
